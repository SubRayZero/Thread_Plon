 ...
 */
final class Version20240417122043 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D64975C0816C FOREIGN KEY (thread_id_id) REFERENCES thread (id)');
