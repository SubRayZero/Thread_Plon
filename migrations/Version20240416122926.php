 ...
 */
final class Version20240416122926 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category ADD CONSTRAINT FK_64C19C15890225A FOREIGN KEY (categoru_id) REFERENCES thread (id)');
